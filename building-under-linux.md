...
The above builds *IdLib Network* without debug information. To build *IdLib Network* with debug information add the parameter `-DCMAKE_BUILD_TYPE="Debug"` to the cmake command.
